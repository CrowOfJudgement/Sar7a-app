...
userRouter.post("/users/resend-confirmation-otp", validation(user.emailOnlySchema), userService.resendConfirmationOtp);
...
userRouter.post("/signIn/resend-otp", validation(user.emailOnlySchema), userService.resendSignInOtp);
...
userRouter.post("/users/2fa/resend-otp", auth, userService.resendTwoFactorEnableOtp);
...
userRouter.post("/users/password/resend-otp", validation(user.emailOnlySchema), userService.resendPasswordResetOtp);
...
userRouter.post('/signUpWithGmail', validation(user.signUpWithGmailSchema), userService.signUpWithGmail);
